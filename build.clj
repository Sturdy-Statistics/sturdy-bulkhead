...
(def lib 'com.sturdystats/sturdy-bulkhead)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "middleware to queue ring requests."]
     [:url "https://github.com/Sturdy-Statistics/sturdy-bulkhead"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/sturdy-bulkhead"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/sturdy-bulkhead.git"]]]})
